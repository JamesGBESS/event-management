...
<template>
    <div class="absolute bottom-16 right-16">
        <button @click="eventStore.RedirectionJavascript('/create')">
            <svg class="hover:bg-blue-500 border-none rounded-full" width="54px" height="54px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <g id="SVGRepo_iconCarrier">
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
                        <g id="Icon-Set-Filled" sketch:type="MSLayerGroup"
                            transform="translate(-466.000000, -1089.000000)" fill="#2563EB">
                            <path
